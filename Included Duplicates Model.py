...
appointed_normal=pd.read_csv("./appointed_model2_21_normalization.csv")
...
appointed_original_feature=pd.read_csv("./appointed_model2_21_original_featureselection.csv")
...
appointed_normal_feature=pd.read_csv("./appointed_model2_21_normalization_featureselection.csv")
